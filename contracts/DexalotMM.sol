...
contract DexalotMM is ERC3156FlashBorrowerInterface {
    /**
    ...
    function onFlashLoan(
        ...
        require(Joetroller(joetroller).isMarketListed(msg.sender), "DexalotMM onFlashLoan: untrusted message sender");
