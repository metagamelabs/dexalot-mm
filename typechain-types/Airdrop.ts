...
export interface AirdropInterface extends utils.Interface {
  ...
  functions: {
    ...
    "claimToPortfolio(uint256,uint256,bytes32[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "claimToPortfolio",
    values: [BigNumberish, BigNumberish, BytesLike[]]
  ): string;
...
export interface Airdrop extends BaseContract {
  ...
  released(index: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
